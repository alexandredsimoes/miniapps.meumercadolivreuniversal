...
namespace MyML.UWP.Services
{
    public interface IMercadoLivreService
    {
        ...
        Task<MLMyItemsSearchResult> ListMyItems(params KeyValuePair<string, string>[] attributes);
        Task<bool> AnswerQuestion(string questionId, string content);        
        Task<bool> RemoveQuestion(string questionId);
        Task<MLUserInfoSearchResult> GetUserInfo(string userId, params KeyValuePair<string, string>[] attributesOrFilters);
        ...
        Task<Item> GetItemDetails(string itemId, params KeyValuePair<string, string>[] attributes);
        ...
        Task<MLOrder> ListOrders(int pageIndex = 0, int pageSize = 0, params KeyValuePair<string,string>[] attributes);
        Task<MLOrder> ListMyOrders(int pageIndex = 0, int pageSize = 0, params KeyValuePair<string, string>[] attributes);

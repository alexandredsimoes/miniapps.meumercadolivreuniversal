...
namespace MyML.UWP.Views
{
    ...
    public sealed partial class Shell : Page
    {
        ...
        public Shell()
        {
            ...
            {
                AdMediatorMobile.AdRefreshed += AdMediatorMobile_AdRefreshed;
                AdMediatorMobile.ErrorOccurred += AdMediatorMobile_ErrorOccurred;
        ...
        private void AdMediatorMobile_ErrorOccurred(object sender, Microsoft.Advertising.WinRT.UI.AdErrorEventArgs e)
        {
            AdMediatorMobile.Visibility = Visibility.Collapsed;
            AdMediatorMobileDuplex.Visibility = Visibility.Visible;
        }

        private void AdMediatorMobile_AdRefreshed(object sender, RoutedEventArgs e)
        {
